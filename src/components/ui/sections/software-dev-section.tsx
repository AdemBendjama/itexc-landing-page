...
function SoftwareDevSection() {
  return (
    <div className="bg-white text-black font-poppins font-normal">
      <div className="flex sm:flex-row flex-col lg:gap-[5rem] sm:gap-12 gap-8 items-center sm:pt-[6.25rem] sm:pb-0 pt-36 pb-12 sm:h-[780px] 2xl:w-[1300px] 2xl:mx-auto xl:mx-[4.375rem] lg:mx-[5%] mx-[1rem]">
